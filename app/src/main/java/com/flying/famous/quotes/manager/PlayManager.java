...
public class PlayManager {
    ...
    public void init() {
        play = SharedPreferencesUtils.init(MyApp.context).getBoolean(PLAY, true);
        ...
        voiceId = soundPool.load(MyApp.context, R.raw.water, 1);
        //异步需要等待加载完成，音频才能播放成功
...
//        });
    ...
    public void onSwitch() {
        play = !play;
        SharedPreferencesUtils.init(MyApp.context).put(PLAY, play);
    }
}
